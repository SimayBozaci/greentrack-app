...
import DetailsPage from './src/components/DetailsPage';
import RezervasyonPage from './src/components/Rezervasyon';
import HomeePage from './src/components/HomeePage'; // Yeni ekranı ekledik
import { Image } from 'react-native';
    ...
    <NavigationContainer>
        ...
        screenOptions={({ route }) => ({
          tabBarIcon: ({ focused }) => {
            ...
            if (route.name === 'Home') {
              ...
              iconName = focused
                ? require('./assets/icons/hırdavat.png')
                : require('./assets/icons/hırdavat.png');
            } else if (route.name === 'Rezervasyon') {
              iconName = focused
                ? require('./assets/icons/calender.png')
                : require('./assets/icons/calender.png');
            } else if (route.name === 'Homee') { 
              iconName = focused
                ? require('./assets/icons/home.png') 
                : require('./assets/icons/home.png');
            }
      ...
      >
        ...
        <Tab.Screen
          name="Details"
          component={DetailsPage}
          options={{ tabBarLabel: 'Detay', headerShown: false }}
        />
        <Tab.Screen
          name="Rezervasyon"
          component={RezervasyonPage}
